...
class VAE(nn.Module):
    def __init__(self, image_size=784, h_dim=400, latent_dim = 20, z_dim=20):
        super().__init__()
...
class VAEPLUS(nn.Module):
    def __init__(self, input_dim=784, hidden_dim=400, latent_dim=20, z_dim=2):
        super(VAEPLUS, self).__init__()
